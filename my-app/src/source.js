export default [
  {
    ...
    question:
      'Václav Morávek vešel do hospody kde sedel inspektor gestapa Oskar Fleischer. Co se tam stalo?',
    answer: [
      'Oslovil ho příteli a nechal si zapálit cigaretu',
      'Zabili ho',
      'Položil mu na stůl časopis V boj',
    ],
    main_image: 'pphlavni',
    stepper_image: 'pphlavni',
    secret:
      'V posledním slově na pamětní desce památníku najděte čtvrté písmenko odzadu.',
    next_point:
      'Adresa dalšího bodu je park Maxe van der Stoela, Bývalý vojenský hřbitov na Hradčanech mezi ulicemi Keplerova, Patočkova',
    latitude: 50.0814464,
...

  {
    ...
    image: ['tj1', 'tj2'],
    descripsion:
      'Zde byl hřbitov hradčanské dělostřelecké posádky a byla tu kde mrtvá schránka Morávka a Thümmela.  Ta jediná se zachovala a vy stojíte přímo před ní.  Thümmel byl agentem německé zpravodajské služby Abwehr a člen NSDAP. Spolupracoval s československou vojenskou rozvětkou už od roku 1937, kde byl veden jako agent A-54. Byl to z jeho strany docela pěkný podnik. Těžil z něj nejen peníze, ale i informace z druhé strany. Byl to dvojí agent a strategicky vypouštěl získané informace,  na tu kterou stranu. Po obsazení Československa sídlil v Petschkově paláci a dodával šéfovi naší rozvědky v Londýně Františku Moravcovi cenné informace. Spojkou v protektorátu byl Václav Morávek.  Thümmel byl znám pod krycím jménem Franta, Holm nebo Eva. Gestapo ho zatklo21.3. 1942, poté ho věznilo na Pankráci a tvrdě vyslýchalo v Petschkárně.',
  ...
  },
  {
    ...
    number: '3',
    image: ['BytZ1', 'bytZ2', 'bytZ3'],
    descripsion:
      'Zemanův byt byl významným uzlem pražského odboje a byl jednou ze základen Tří králů. K odbojové činnosti za druhé světové války patřilo v okupovaném Československu i získávání informací pro exilovou zpravodajskou službu. Nestačilo ovšem jen cenné informace shromáždit, musely se také doručit na místo určení. O předání za hranice se odboj snažil radiotelegrafickou cestou či pomocí tzv. kurýrů. Při zajišťování kurýrních „služeb“ pro odbojovou skupinu Tří králů dělal právě Jiří Zeman a to jako průvodčí mezinárodní vlakové pošty a společnosti lůžkových vozů. Zeman byl průvodčí na trasách Wagons-Lits, který spolu s kolegou Aloisem Fürbacherem převezl okolo 25 000 zpráv. Vlaky byly ideální pro přepravu takřka čehokoliv, a tak nejeden lůžkový vůz ukrýval důležité fotografie, nákresy, rozbušky pro detonační směsi či součástky k vysílačkám. A také československé politiky a vojáky při útěku za hranice, případně jejich rodinné příslušníky, když hrozila možnost zneužití pro vydírání důležitých osob v exilu.Průvodčí úspěšně vyvezli třiadvacet důstojníků spolu se třemi letci, ukrytými pod lůžkem v salonku Marthy von Papen, cestující do Istanbulu za svým manželem, tehdy vyslancem v Turecku.Jakožto kurýr převážel zásilky vozu na tratích Praha-Paříž a Praha-Varšava. Po napadení Polska nacistickým Německem začíná jezdit novou trasu Praha-Bělehrad-Istanbul.V Bělehradu přebíral dodané informace zpravodajský důstojník major Jaroslav Hájíček (podílel se na zřízení radiostanice k propojení s domácím odbojem) plus diplomat a někdejší velvyslanec v Jugoslávii Jaroslav Lípa. Zeman měl spojení i na jugoslávský generální konzulát v Praze přes zdejšího úředníka Božidara Stefanoviče.Zemanovi pomáhala rovněž dcera, pozdější herečka v divadle Oldřicha Nového. Aby ho gestapo nechytilo s kompromitujícím materiálem (včetně trhavin), nosívala jej Jiřina Zemanová ukrytý v košíku pod jídlem. „Svačinu pro otce“ pak před odjezdem vlaku předala některému z jeho kolegů. Jiří Zeman byl zatčen ve stejný rok, kdy zastřelili Morávka, byl popraven ve stejný den na stejném místě jako Josef Mašín.',
    ...
    next_point:
      'Adresa dalšího bodu je Studentská 529/1, 160 00 Praha 6 - Dejvice,',
    latitude: 50.0716836,
  ...
  },
  {
    ...
    number: '4',
    image: ['studenska1', 'studenska2', 'studenska3', 'studenska4'],
    descripsion:
    ...
    next_point:
      'Adresa dalšího bodu je Čiklova 1238/19, 140 00 Praha 4 - Nusle',
    latitude: 50.1005878,
  ...
  },
  {
    ...
    question: 'Při útěku se Morávek zravil, co si uřízl během útěku?',
    ...
    next_point:
      'Adresa dalšího bodu je byt Marie Magdy Rezkové - Anny Letenské 1197/3, 120 00 Praha 2 - Vinohrady',
    latitude: 50.0771481,
  ...
  },
  {
    ...
    question: 'Jak se jmenovali vysílačky, které Tři králové používali?',
    ...
    next_point:
      'Adresa dalšího bodu je Karlova 145/25, 110 00 Praha 1 - Staré Město',
    longitude: 14.4373258,
    latitude: 50.0771481,
  },
  {
    ...
    secret:
      'Jdi o několik domu z kopce dolů, směr vinohradská ulice najdeš zde pamětní desku, na které jsou jména lidí popravená gestapem. Najdi člověka popraveného18.11.1943. Správné písmeno je třetí odzadu z jeho jména.',
    next_point:
      'Adresa dalšího bodu je Staroměstské náměstí 478/26, 110 00 Praha 1 - Staré Město,',
    longitude: 14.4189408,
    latitude: 50.0863453,
  },
  {
    ...
    secret:
      'Jdi o několik domu z kopce dolů, směr vinohradská ulice najdeš zde pamětní desku, na které jsou jména lidí popravená gestapem. Najdi člověka popraveného18.11.1943. Správné písmeno je třetí odzadu z jeho jména.',
    next_point:
      'Adresa dalšího bodu je Pomník Václava Morávka v Morávkově parku, Praha 6 - Dejvice. Je to mezi ulicemi Svatovítská a Milady Horákové.',
    longitude: 50.0865442,
    latitude: 14.420785,
  },
  {
    ...
    next_point:
      'Adresa posledního bodu je Vazební věznice, Soudní 988/1, 14000 Praha 4 - Nusle,',
    longitude: 14.3960244,
    latitude: 50.0951161,
  },
  {
